...
var m_gray_v30: Material = preload("res://materials/gray_v30.material")
var m_gray_v10: Material = preload("res://materials/gray_v10.material")
var m_gray_v50: Material = preload("res://materials/gray_v50.material")
var m_gray_v70: Material = preload("res://materials/gray_v70.material")
var m_gray_v60: Material = preload("res://materials/gray_v60.material")
var m_gray_v80: Material = preload("res://materials/gray_v80.material")
...
func build_centered(center_ = Vector3.ZERO, size_ = Vector3.ONE,
	...
	CollisionManager.setup_terrain_layer_mask(cube_)
...
# Create prismatic StaticBody with MeshInstance and CollisionShape. Local coordinates !
func build_centered_mobwall(center_ = Vector3.ZERO, size_ = Vector3.ONE,
			 parent_ = self, has_collision_shape = true):
	var cube_: StaticBody = StaticBody.new()
	# Set collision layer and mask
	CollisionManager.setup_mobwall_layer_mask(cube_)
	...
	mesh_instance_.mesh = CubeMesh.new()
	mesh_instance_.mesh.set_size(Vector3(size_.x, size_.y, size_.z))
	mesh_instance_.mesh.set_material(null)
