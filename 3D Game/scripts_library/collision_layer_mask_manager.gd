...
func setup_player_layer_mask():
	set_collision_layer(1)
	set_collision_mask(30)
	
	
func setup_terrain_layer_mask():
	set_collision_layer(2)
	set_collision_mask(13)
	
	
func setup_mob_layer_mask():
	set_collision_layer(4)
	set_collision_mask(15)
	
	
func setup_weapon_layer_mask():
	set_collision_layer(8)
	set_collision_mask(7)
	
	
func setup_pickuptrap_layer_mask():
