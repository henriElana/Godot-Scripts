...
func make_model():
	...
	var mat = preload("res://materials/noblur_v10.material")
	...
	mat = preload("res://materials/noblur_v10.material")
	meshinstance.mesh.set_material(mat)
	...
	mat = preload("res://materials/noblur_fx_yellow.material")
	meshinstance.mesh.set_material(mat)
	...
	mat = preload("res://materials/noblur_pastel_cyan.material")
	meshinstance.mesh.set_material(mat)
...
func make_camera():
	...
	#Motion blur
	var mb_scene = load("res://motion_blur/motion_blur.tscn")
	var mb = mb_scene.instance()
	my_camera.add_child(mb)
